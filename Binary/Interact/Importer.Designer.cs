namespace Binary.Interact
{
	partial class Importer
	{
        ...
        private void InitializeComponent()
        {
            ...
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(Importer));
            ...
            this.ImporterType.Items.AddRange(new object[] { "Negate", "Synchronize", "Override" });
            ...
            this.ImporterButton.Click += this.ImporterButton_Click;
            // 
            // Importer
            // 
